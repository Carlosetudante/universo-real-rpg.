const CACHE_NAME = 'universo-real-v54';
...
self.addEventListener('fetch', event => {
  ...
  // Não intercepta requisições externas (ex: Supabase/API de terceiros).
  // Isso evita retorno indevido de offline em chamadas de banco.
