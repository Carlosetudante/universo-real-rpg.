...
(async () => {
  ...
  fs.writeFileSync('tools/ui_test_hebrew_retry_result.json', JSON.stringify({ runAt: new Date().toISOString(), results }, null, 2));
  console.log('Retry concluído. Resultado salvo em tools/ui_test_hebrew_retry_result.json');
